    ...
    <SafeAreaView className="flex-1 bg-white">
      <ScrollView showsVerticalScrollIndicator={false} className="h-screen">
            <View className="flex-col px-[35px] translate-y-[150px] h-screen">
              <View className="mb-8">
                <Text className="text-dark   text-[40px]">Sign Up  </Text> 
              </View>
              <View>

              <View className="mb-8">
                <Text className="text-fade">Full name  </Text> 
                <TextInput placeholder="Full Name" className="w-full flex-row justify-center items-center   p-2 w-full  opacity-40    rounded-md border-[1px]   border-primary" />
              </View>

              <View className="mb-8">
                <Text className="text-fade">E-mail  </Text> 
                <TextInput placeholder="E-mail" className="w-full flex-row justify-center items-center   p-2 w-full  opacity-40    rounded-md border-[1px]   border-primary" />
              </View>
              ...
              <TouchableOpacity onPress={()=>navigator.navigate("Signup")} className="  flex-row justify-center items-center w-full h-[65px]   bg-primary  rounded-full border-[1px]   border-white ">
                 <Text className="text-white opacity-90 ">SIGN UP</Text>
              </TouchableOpacity  > 
               </View>

              <View className="flex-row gap-[2px] justify-center items-center w-full  " > 
              <Text className=" opacity-90 mb-9"> Already have an account?</Text>
              <TouchableOpacity onPress={()=>navigator.navigate("Login")} className="flex-row justify-center items-center         ">
                <Text className="mb-9 text-primary">Login</Text>  
